...
const APP_CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .cell-link-left { margin-left: -4px; width: calc(100% + 4px); min-width: calc(100% + 4px); border-top-left-radius: 5px; border-bottom-left-radius: 5px; }
  .cell-link-right { margin-right: -4px; width: calc(100% + 4px); min-width: calc(100% + 4px); border-top-right-radius: 5px; border-bottom-right-radius: 5px; }
  .cell-link-left.cell-link-right { margin-left: -4px; margin-right: -4px; width: calc(100% + 8px); min-width: calc(100% + 8px); border-radius: 5px; }
  .vacation-join-shadow { box-shadow: inset 0 0 0 1px rgba(255,255,255,.08), 0 0 0 1px rgba(34,197,94,.12); }
                        ...
                        <tr key={employee.id}>
                          ...
                          {monthDays.map((date, dayIndex) => {
                            ...
                            const ferieLinkClass = currentCode === 'F'
                              ? `${prevCode === 'F' ? ' cell-link-left' : ''}${nextCode === 'F' ? ' cell-link-right' : ''} vacation-strong vacation-join-shadow`
                              : ''
